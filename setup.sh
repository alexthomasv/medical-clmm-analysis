...
# 2. Authenticate with Google (User Login)
echo "Starting Google Authentication..."
gcloud auth login

# 3. Set the Quota Project (Vital for gspread 403 errors)
echo "Setting Quota Project to 'blues-medical'..."
gcloud auth application-default set-quota-project blues-medical

# 4. Create Application Default Credentials with Drive/Sheets scopes
